...
<head>
    ...
    <meta name="generator" content="Nicepage 5.6.2, nicepage.com">
      ...
      <div class=tela1>
        <div class="caixatexto1">
          <h3>ADOTE.ME</h3>
          <p>Existem várias vantagens em adotar um animal abandonado. Em primeiro lugar, você estará salvando uma vida. Muitos animais em abrigos foram abandonados por seus antigos donos ou resgatados de situações de maus-tratos. Ao adotar, você estará dando a esses animais uma nova oportunidade de serem amados e cuidados.</p>
      ...
      <div class="tela2">
        <div class="caixatexto2">
            <div class="bordaimg">
          <img src="images/xxxxx.jpg" alt="imagens de cachorro e gato juntos">
          </div>
          </div>
          <div class="caixatexto2-2">
            <h3>VENHA CONHECER NOSSOS ANIMAIS PARA DOAÇÂO</h3>
            <p>Os animais merecem amor, atenção e um lar seguro ajude-nos a tornar isso possível .</p>
            <a href="imprimir.php"><button>Lista de animais</button></a>
    ...
    <div class="tela3">
          ...
          <h3>FAÇA UM ANIMAL FELIZ</h3>
          <p>Lembre-se de que um animal de estimação é uma decisão importante e que você deve sempre agir com responsabilidade e garantir que o animal esteja sendo acolhido em um lar seguro e amoroso. </p>
