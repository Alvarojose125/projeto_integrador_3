...
<!--
        <video autoplay loop poster="/images/8.jpg" class="video_fundo">
	        <source src="video/video1.mp4" type="video/mp4">
          </video>
-->
          <h6>Quem nós somos?</h6>
          <p>Adote.me é um programa criado para estreitar laços entre pessoas que têm o sonho de adotar um pet e nossas ONGs e protetores parceiros. Vamos juntos incentivar a adoção, conscientizar sobre a posse responsável e fomentar a cultura de doação em prol do bem-estar animal.</p><break></break>
          <h6>Qual o nosso objetivo?</h6>
          <p>O objetivo principal do nosso site é facilitar a conexão entre animais que precisam de um lar e pessoas que estão procurando por um animal de estimação. Tudo isso de forma segura, simples e confiavél.</p>

        </div>
       
            <p class="link">  
              Gostou da iniciativa? Que tal adotar um bixinho?
